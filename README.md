...
Ожидаемый результат текущего шага: сетевое поведение не меняется, улучшается только надёжность скачивания.
